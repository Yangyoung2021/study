...
* 实现原理
  TTL+死信队列
  ![](../pictures/Snipaste_2022-09-25_20-59-20.png)

* 具体实现和使用TTL过期的死信作为需要延迟的消息发送给死信交换机，再发给死信队列，然后通过在库存模块中监听死信队列就能达到延迟队列的功能。具体实现过程参照死信队列实现过程。
...
* 流程
  ![](../pictures/Snipaste_2022-09-25_21-41-41.png)

### 3.2 消息幂等性保障

* 实现步骤
  ![](../pictures/Snipaste_2022-09-25_21-46-58.png)
